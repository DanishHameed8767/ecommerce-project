          ...
          <div className="container">
            <div className="row d-flex justify-content-center">
              <div className="col-md-4 mb-3">
                <div className="text-center mx-auto feature-icons-ellipse1">
                  <div className="bgc-black feature-icons-ellipse2">
                    <img alt="100%x280" src={C1} height="40px" width="40px" />
                  </div>
                </div>
                <div>
                  <div className="fs-5 text-center fw-bold mt-3">
              ...
              <div className="col-md-4 mb-3">
                <div className="text-center mx-auto feature-icons-ellipse1">
                  <div className="bgc-black feature-icons-ellipse2">
                    <img alt="100%x280" src={C2} height="40px" width="40px" />
                  </div>
                </div>
                <div>
                  <div className="fs-5 text-center fw-bold mt-3">
              ...
              <div className="col-md-4 mb-3">
                <div className="text-center mx-auto feature-icons-ellipse1">
                  <div className="bgc-black feature-icons-ellipse2">
                    <img alt="100%x280" src={C3} height="40px" width="40px" />
                  </div>
                </div>
                <div>
                  <div className="fs-5 text-center fw-bold mt-3">
